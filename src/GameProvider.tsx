...
export const initialState: GameState = {
  ...
  rolled: false,
  dice: [
    { id: diceIds[0], hold: false, count: 0, score: 0 },
    { id: diceIds[1], hold: false, count: 0, score: 0 },
    { id: diceIds[2], hold: false, count: 0, score: 0 },
    { id: diceIds[3], hold: false, count: 0, score: 0 },
    { id: diceIds[4], hold: false, count: 0, score: 0 },
  ],
  scores: new Map(),
  selectedScore: null,
  upperScoreBonus: 0,
