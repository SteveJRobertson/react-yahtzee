...
export const getFours = (diceScore: DiceNumbers) => getNumberScore(diceScore, 4)
export const getFives = (diceScore: DiceNumbers) => getNumberScore(diceScore, 5)
export const getSixes = (diceScore: DiceNumbers) => getNumberScore(diceScore, 6)
